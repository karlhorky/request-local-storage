...
if (true) var key = "_request_local_storage_", cls = require("continuation-local-storage").createNamespace(key), bind = cls.bind.bind(cls), patch = function patch(func) {
    return func(cls);
...
var namespaces = 0, getCountNamespaces = function getCountNamespaces() {
    ...
    if (true && Object.observe) Object.observe(getter, function(changes) {
